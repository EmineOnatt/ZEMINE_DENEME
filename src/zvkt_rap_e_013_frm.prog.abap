...
*  ls_variant-handle = 'YAS'. " HER ALV İÇİN AYRI VARYANT
    ...
    CASE sy-subrc.
      WHEN 0.
        ...
        LOOP AT gt_fcat INTO DATA(ls_fcat).
          ...
          CONDENSE gs_cellstyle-fieldname NO-GAPS.
          TRANSLATE gs_cellstyle-fieldname TO UPPER CASE.
...
*    MESSAGE 'Kayıt Değiştirildi...' TYPE 'I'.
    message s009(ZEO_001) DISPLAY LIKE 'I'.
  ELSE.
*    MODIFY zvkt_eo_t005 FROM ls_kayit.
