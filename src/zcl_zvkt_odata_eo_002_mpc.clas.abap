class ZCL_ZVKT_ODATA_EO_002_MPC definition
  public
...
CLASS ZCL_ZVKT_ODATA_EO_002_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZVKT_ODATA_EO_002_SRV' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20220418113542'.                  "#EC NOTEXT
...
*   4
*&---------------------------------------------------------------------*
    CONSTANTS: co_gen_date_time TYPE timestamp VALUE '20220418123543'.
    TRY.
  ...
  method IF_SADL_GW_MODEL_EXPOSURE_DATA~GET_MODEL_EXPOSURE.
    CONSTANTS: co_gen_timestamp TYPE timestamp VALUE '20220418123543'.
    DATA(lv_sadl_xml) =
   ...
   ro_model_exposure = cl_sadl_gw_model_exposure=>get_exposure_xml( iv_uuid      = CONV #( 'ZVKT_ODATA_EO_002' )
