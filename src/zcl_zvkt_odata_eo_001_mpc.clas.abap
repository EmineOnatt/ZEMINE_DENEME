class ZCL_ZVKT_ODATA_EO_001_MPC definition
  public
...
CLASS ZCL_ZVKT_ODATA_EO_001_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZVKT_ODATA_EO_001_SRV' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20220407062340'.                  "#EC NOTEXT
