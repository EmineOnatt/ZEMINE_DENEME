class ZCL_ZVKT_ODATA_EO_004_MPC definition
  public
...
public section.
  ...
  types:
   TS_ZEO_DDL002TYPE type ZEO_CDS002 .
  types:
   TT_ZEO_DDL002TYPE type standard table of TS_ZEO_DDL002TYPE .

  constants GC_ZEO_DDL002TYPE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ZEO_DDL002Type' ##NO_TEXT.
...
CLASS ZCL_ZVKT_ODATA_EO_004_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZVKT_ODATA_EO_004_SRV' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20220418134215'.                  "#EC NOTEXT
...
*   4
*&---------------------------------------------------------------------*
    CONSTANTS: co_gen_date_time TYPE timestamp VALUE '20220418144216'.
    TRY.
  ...
  method IF_SADL_GW_MODEL_EXPOSURE_DATA~GET_MODEL_EXPOSURE.
    CONSTANTS: co_gen_timestamp TYPE timestamp VALUE '20220418144216'.
    DATA(lv_sadl_xml) =
   ...
   ro_model_exposure = cl_sadl_gw_model_exposure=>get_exposure_xml( iv_uuid      = CONV #( 'ZVKT_ODATA_EO_004' )
