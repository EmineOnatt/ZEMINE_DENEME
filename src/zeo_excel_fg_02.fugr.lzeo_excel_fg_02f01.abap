...
**    SET PROPERTY OF gv_int 'COLORINDEX' = 55 .
*    SET PROPERTY OF gv_int 'PATTERN' = 1 .
*
...
*    #2 = 1. "Column
*
*    SET PROPERTY OF gv_cell1 'Value' = 'Satış Bilgileri'.
