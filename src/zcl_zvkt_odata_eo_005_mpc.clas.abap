class ZCL_ZVKT_ODATA_EO_005_MPC definition
  public
...
CLASS ZCL_ZVKT_ODATA_EO_005_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZVKT_ODATA_EO_005_SRV' ).
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'TABLO1Set' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20220421072017'.                  "#EC NOTEXT
