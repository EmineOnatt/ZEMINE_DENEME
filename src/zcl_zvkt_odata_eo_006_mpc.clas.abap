class ZCL_ZVKT_ODATA_EO_006_MPC definition
  public
...
public section.
  ...
  types:
         TS_HEADER type ZODATA_EO_S_TABLO1 .
  types:
  ...
  types:
         TS_ITEM type ZODATA_EO_S_TABLO2 .
  types:
...
CLASS ZCL_ZVKT_ODATA_EO_006_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZVKT_ODATA_EO_006_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZODATA_EO_S_TABLO1'
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZODATA_EO_S_TABLO2'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20220421072348'.                  "#EC NOTEXT
